...
build_config! {
    {
        ...
        (blocks_request_timeout_ms, (u64), 15_000)
        (check_request_period_ms, (u64), 500)
        ...
        (headers_request_timeout_ms, (u64), 7_500)
        ...
        (max_downloading_chunks, (usize), 24)
        ...
        (max_inflight_request_count, (u64), 256)
