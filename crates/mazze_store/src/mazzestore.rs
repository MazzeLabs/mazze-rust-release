...
impl MazzeStore {
    ...
    pub fn open_with_iterations(
        ...
        Ok(MazzeStore {
            store: MazzeMultiStore::open_with_iterations(
...
/// Similar to `MazzeStore` but may store many accounts (with different
/// passwords) for the same `Address`
