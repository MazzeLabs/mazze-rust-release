...
impl PosHandler {
    ...
    pub fn config(&self) -> &PosConfiguration {
        &self.conf
    }

    fn pos(&self) -> &Box<dyn PosInterface> {
        self.pos.get().unwrap()
    }
    ...
    pub fn is_enabled_at_height(&self, _height: u64) -> bool {
        // TODO: gracefully remove PoS reference & checks or make them part of the process
        // TODO: with earnable stake to 
...
fn diem_hash_to_h256(h: &HashValue) -> PosBlockId {
    H256::from(h.as_ref())
}
