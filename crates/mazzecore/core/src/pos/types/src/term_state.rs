...
impl NodeData {
    pub fn lock_status(&self) -> &NodeLockStatus {
        &self.lock_status
    }
}
...
impl Default for NodeList {
    fn default() -> Self {
        NodeList::Electing(Default::default())
    }
}
...
impl ElectedMap {
    pub fn inner(&self) -> &BTreeMap<AccountAddress, u64> {
        &self.0
    }
}
...
impl TermList {
    ...
    pub fn term_list(&self) -> &Vec<TermData> {
        &self.term_list
    }
}
...
impl PosState {
    ...
    pub fn main_decision(&self) -> &MainBlockDecision {
        &self.main_decision
    }
    ...
    pub fn term_list(&self) -> &TermList {
        &self.term_list
    }
