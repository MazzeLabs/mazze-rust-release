//! Mazze Executor: A Rust crate for the core logic of executing transactions
//! on the Mazze blockchain. It encapsulates all the necessary logic for a
...
/// the Mazze specification, and submitting them to the execution engine.
pub mod executive;

/// Mazze Internal Contracts: Implements Mazze's builtin contracts.  
...
/// Stack Management for Execution Engine: Mazze's execution engine is
...
/// achieve backward compatibility with different versions of the Mazze
